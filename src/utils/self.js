$(function() {
	...
	function men_3d() {
		...
		console.log($("#people_model").vc3dEye)
		$("#people_model").vc3dEye('#people_model', {
			// imagePath: "http://192.168.20.222:8989/3deye/men_3d/",
			imgePath: "public/imgs/men_3d/",
			totalImages: 43,
			imageExtension: "png"
		});
	...
	function women_3d() {
		$("#people_model").vc3dEye({
			// imagePath: "http://192.168.20.222:8989/3deye/women_3d/",
			imgePath: "public/imgs/women_3d/",
			totalImages: 58,
			imageExtension: "png"
		});
		var bg_src = $("#people_model").css("background-image").split("\"")[1];
